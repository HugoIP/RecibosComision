   ...
   (function($) {
       $('#getContenido').keyup(function () {
        ...
        if(contentString.length==30)
        {
            ...
            getPay = parseFloat(contentString.substring(20,29));
            ...
            $("#SPAY" ).val(getPay);
            $("#LOCA" ).val(location);
            $("#TOTA" ).val(getPay+ parseFloat(comision));
         }
       })     
      }(jQuery));
});
  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="index.php">Recibos Comision</a>
...
<form id="frmLogin" action="" method="post">
    ...
    <input id="COMI" class="form-control" type="text" name="comi"  placeholder="6.5" value="">
     ...
     <div class="col" class="p-3 mb-2 bg-light text-dark">
