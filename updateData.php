...
if(isset($_GET['barCode'])){
  ...
  $msg=$msg." = ".$limitPay."  :".$texStatus."  :".$orderGrup."  :".$serviceNum."  =";

	$consulta="UPDATE Servicios SET barCode=$barCode, limitPay=$limitPay,texStatus=$texStatus, orderGrup=$orderGrup WHERE serviceNum=$serviceNum";
